...
/// Optional context for DecisionsRequest
...
@class SFPDecisionsResponsePersonalizationContentObject;
...
@property (nonatomic, readonly, copy) NSArray<SFPDecisionsResponsePersonalizationContentObject *> * _Nonnull data;
...
@interface SFPDecisionsResponsePersonalizationContentObject : NSObject
/// The raw JSON from which this class was initialized from. Can be useful for logging etc.
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nonnull rawJson;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
